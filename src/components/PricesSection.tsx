...
const seasons = [
  {
    ...
    isPopular: false,
    icon: Flower2,
    description: "Весна — тихо, меньше людей, выгодные цены. Цветущие сады и пустые пляжи для спокойного отдыха.",
  ...
  },
  {
    ...
    price: 8500,
    icon: Sun,
    description: "Золотая середина: тёплое море, длинные дни и ещё нет летнего наплыва. Успейте до пика!",
    features: ["Комфортная температура", "Тёплое море", "5 ночей для семьи 2+2 — от 42 500 ₽"],
  },
  {
    id: "peak",
    label: "Высокий сезон",
    ...
    isPopular: true,
    icon: Waves,
    description: "Лето — максимум солнца и моря. Жаркие дни, тёплая вода и все активности для семьи.",
  ...
  },
  {
    ...
    tag: "Рекомендуем",
    icon: Sparkles,
    description: "Бархатный сезон — тёплое море без жары. Мягкое солнце, спелые фрукты и уютная атмосфера.",
    features: ["Тёплое море без жары", "Спелые фрукты", "5 ночей для семьи 2+2 — от 45 000 ₽"],
  },
  {
    id: "autumn",
    label: "Осень",
    ...
    price: 7000,
    icon: Leaf,
    description: "Золотая осень в горах — красочная природа, тёплые дни и полное уединение на побережье.",
    features: ["Красочная природа", "Тишина и уединение", "5 ночей для семьи 2+2 — от 35 000 ₽"],
  },
  {
    id: "vip",
    label: "VIP домик",
