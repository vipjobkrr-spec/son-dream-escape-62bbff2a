...
const BookingForm = () => {
  ...
  const inputClass =
    "w-full px-4 py-3 rounded-md bg-popover border border-input text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 transition-shadow";
      ...
      <div className="container max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="bg-popover rounded-lg p-6 md:p-8 shadow-card space-y-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <button
              type="submit"
              className="flex-1 px-6 py-4 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
            >
              Отправить заявку
            </button>
            <a
